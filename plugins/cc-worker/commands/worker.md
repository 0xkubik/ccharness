...
argument-hint: "[task / problem / idea — or nothing to find the work] [--auto] [--plan] [--fast] [--worktree] [--ultracode]"
---
...
- **Flags** (`--auto`, `--plan`, `--fast`, `--worktree`, `--ultracode`) → tune *how* you work, never *what* —
