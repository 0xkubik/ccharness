...
piece in its home. First **load the rule sets** — `cc-setup:feature-management`,
`cc-setup:architecture-management` (with `cc-tools:likec4` for syntax), and
`cc-setup:spec-management` — their rules govern what you write; this command only runs the loop.
