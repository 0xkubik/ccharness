...
do is the foot of the script and builds from the product's goal outward, so it first
...
`/how-to-do` (the script's decision loop); a business / non-technical one it declines outright; a
