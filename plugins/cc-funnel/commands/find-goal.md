...
**North Star** (vision · core problem · level) at the top of `.claude/ccharness/roadmap.md`, then
**offers** to lay out the **roadmap** — a **flat, ordered list of features** below it, built top to
