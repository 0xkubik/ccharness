...
what-to-do is the mouth of the funnel (what-to-do → how-to-do → do → refactor-review-test), grounded by `/roadmap-management`
upstream. It runs with or without an argument, but it **requires the product's North Star**: if none
is set, it routes you to **`/roadmap-management`** (which captures it) and stops. With the North Star present,
