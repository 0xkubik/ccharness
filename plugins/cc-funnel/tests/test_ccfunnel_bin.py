...
class TestCcfunnelBin(unittest.TestCase):
    ...
    def test_bin_exists_and_executable(self):
        self.assertTrue(BIN.exists(), "bin/ccfunnel missing")
        self.assertTrue(os.access(BIN, os.X_OK), "bin/ccfunnel not executable")
    ...
    def test_help_exits_0(self):
        ...
        self.assertIn("ccfunnel", r.stdout)
