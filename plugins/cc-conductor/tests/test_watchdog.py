...
from ccconductor import watchdog
...
def entry(native=True, launched=False):
    return {"native": {"status": "busy"} if native else None, "launched_by_ccconductorctl": launched}
