...
class TestReport(unittest.TestCase):
    def setUp(self):
        ...
        import importlib, ccconductor.config, ccconductor.paths, ccconductor.report
        for m in (ccconductor.config, ccconductor.paths, ccconductor.report): importlib.reload(m)
        self.report = ccconductor.report
