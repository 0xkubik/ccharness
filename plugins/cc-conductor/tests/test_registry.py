...
class TestRegistry(unittest.TestCase):
    def setUp(self):
        ...
        import importlib, ccconductor.config, ccconductor.registry
        importlib.reload(ccconductor.config); importlib.reload(ccconductor.registry)
        self.r = ccconductor.registry
    ...
    def test_merge_keys_by_session_id(self):
        ...
        self.assertTrue(merged["s1"]["launched_by_ccconductorctl"])
    ...
    def test_merge_keeps_launched_agent_absent_from_native(self):
        ...
        self.assertTrue(merged["gone"]["launched_by_ccconductorctl"])
