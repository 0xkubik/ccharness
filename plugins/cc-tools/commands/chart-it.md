...
**roadmap** — a sequenced route of lightweight milestones (`.claude/ccharness/roadmap.md`) from where
the product is now to that North Star. Other product skills (`point-it`, `grill-it`, `implement-it`,
